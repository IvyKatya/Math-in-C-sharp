...
// написать умножение матриц, деление(3 задачи, обратная матр, определитель, прив-е к треугольному виду):
// написать свой метод обращения к матрице (проверить умножить матрицу на обратную ей =1 на диагонали)
